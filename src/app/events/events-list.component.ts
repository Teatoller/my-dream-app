  ...
  events = [
    {
      ...
      sessions: [
        {
          id: 1,
          name: "ALC with PluralSight",
          presenter: "Mercy Cheruto",
          duration: 1,
          level: "Intermediate",
